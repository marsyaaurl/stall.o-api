...
export async function createSellerReservation(sellerId, input) {
...
export async function getSellerReservations(sellerId, query) {
...
export async function cancelSellerReservation(sellerId, reservationId) {
...
export async function stockSellerReservation(sellerId, reservationId) {
