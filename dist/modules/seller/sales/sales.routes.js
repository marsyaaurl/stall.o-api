...
router.get('/overview', authenticateJWT, authorizeRoles(UserRole.SELLER), async (req, res) => {
    try {
...
router.get('/revenue', authenticateJWT, authorizeRoles(UserRole.SELLER), async (req, res) => {
    try {
...
router.get('/top-products', authenticateJWT, authorizeRoles(UserRole.SELLER), async (req, res) => {
    try {
...
router.get('/transactions', authenticateJWT, authorizeRoles(UserRole.SELLER), async (req, res) => {
    try {
