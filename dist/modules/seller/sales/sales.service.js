...
export async function getSalesOverview(sellerId, query) {
    const whereClauseItem = {
...
export async function getRevenueOverTime(sellerId, query) {
...
export async function getTopProducts(sellerId, query) {
    const { startDate, endDate } = query;
    const whereClause = {
        productBatch: { sellerId },
        order: {
...
export async function getTransactions(sellerId, query) {
