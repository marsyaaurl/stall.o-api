...
export async function getSellerMachines(query) {
...
export async function getSellerMachineById(machineId) {
...
export async function getMachineSlotAvailability(machineId, startDate, endDate) {
    ...
    const occupiedSlotCodes = new Set();
